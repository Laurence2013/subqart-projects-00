...
npm install --save-dev rxjs@latest rimraf@latest nodemon@latest newman@latest morgan@latest mongodb-memory-server@latest lint-staged@latest
npm install --save-dev mongoose@latest joi@latest jest@latest immutable@latest husky@latest helmet@latest globals@latest express@latest
npm install --save-dev eslint-plugin-mocha@latest eslint-plugin-jest@latest eslint@latest dotenv@latest debug@latest cypress@latest
